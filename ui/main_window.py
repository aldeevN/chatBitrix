...
class TelegramChatWindow(QMainWindow):
    def __init__(self):
        ...
        self.api = BitrixAPI("https://ugautodetal.ru/rest/{self.user_id}/{self.user_auth_token}/")
    ...
    def load_auth_data(self):
        ...
        if os.path.exists('auth_data_full.json'):
            try:
                ...
                print(f"  Loaded auth data from JSON ({len(auth_data)} items)")
